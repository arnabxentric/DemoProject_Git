...
{
    public class PurchaseReceiptModelView
    {
        ...
        //[Required(ErrorMessage = "Please choose a Purchase Order to Proceed.")]
        ...
        [Required(ErrorMessage = "The Challan Code field is required.")]
        ...
        public List<PurchaseReceiptDetailModelView> pod { get; set; }
    }
}