...
namespace XenERP.Models
{
    ...
    public class NumberToEnglish
    {
        ...
        public static void getBS(string report)
        {

            //string fromAddress = "pramod@xentrictechnologies.com";
            //string toAddress = "pramod@xentrictechnologies.com";
            //string fromPassword = "x03041983";
            //string mailSubject = "RCCPL";
