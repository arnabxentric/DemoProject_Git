$(function () {
    ...
    $get_lastIDEdit = function (ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount, TaxId, TaxName, TotalAmount, Available) {
    ...
    $add_rowEdit = function (ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount, TaxId, TaxName, TotalAmount, Available) {

        $get_lastIDEdit(ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount, TaxId, TaxName, TotalAmount, Available);
