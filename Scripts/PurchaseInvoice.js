    ...
    $get_lastIDEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, TaxId, TaxName, TotalAmount, Available) {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='productcode_0' class='productcode_0 ' width='10%'><input type='text' value='" + ItemName + "'  class='productcodehide input-non-active' name='productcodehide' readonly /></td> \
                    ...
                    <td id='taxes_0' class='taxes_0'  width='12%'><input type='text' value='" + TaxName + "'  class='taxhide input-non-active' name='taxhide' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='taxes_0" + $lastChar + "' class='taxes_0'  width='12%'><input type='text' value='" + TaxName + "'  class='taxhide input-non-active' name='taxhide' readonly /></td> \
