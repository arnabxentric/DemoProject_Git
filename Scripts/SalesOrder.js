$(function () {
    ...
    $get_lastID = function () {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='availability_0' class='availability_0' width='5%'><input type='text' value=''  class='availabilityhide input-non-active' style='text-align:right;' name='availabilityhide' readonly /></td> \
                    ...
                    <td id='disamount_0' class='disamount_0' width='10%'><input type='text' value=''  class='disamounthide input-non-active' style='text-align:right;' name='disamounthide' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='availability_0" + $lastChar + "' class='availability_0' width='5%'><input type='text' value=''  class='availabilityhide input-non-active' style='text-align:right;' name='availabilityhide' readonly /></td> \
    ...
    $get_lastIDEdit = function (ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available) {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='availability_0' class='availability_0' width='5%'><input type='text' value='" + Available + "'  class='availabilityhide input-non-active' style='text-align:right;' name='availabilityhide' readonly /></td> \
                    ...
                    <td id='disamount_0' class='disamount_0' width='10%'><input type='text' value='" + DiscountAmount + "'  class='disamounthide input-non-active' style='text-align:right;' name='disamounthide' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='availability_0" + $lastChar + "' class='availability_0' width='5%'><input type='text' value='" + Available + "'  class='availabilityhide input-non-active' style='text-align:right;' name='availabilityhide' readonly /></td> \
    ...
    $add_rowEdit = function (ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available) {

        $get_lastIDEdit(ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available);
