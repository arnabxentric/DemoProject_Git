$(function () {
    ...
    $get_lastID = function () {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='totalquantity_0' class='totalquantity_0 display-non-div' style='display:none;padding:0px;'  width='8%'><input type='text' value=''  class='totalquantityhide input-non-active' style='text-align:right;' name='totalquantityhide' readonly /></td> \
                    ...
                    <td id='unitprice_0' class='unitprice_0' display-non-div' style='display:none;padding:0px;' width='10%'><input type='text' value=''  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
                    <td id='amount_0' class='amount_0' display-non-div' style='display:none;padding:0px;' width='10%'><input type='text' value=''  class='amounthide input-non-active' style='text-align:right;' name='amounthide' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='unitprice_0" + $lastChar + "' class='unitprice_0' display-non-div' style='display:none;padding:0px;' width='10%'><input type='text' value=''  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
                    <td id='amount_0" + $lastChar + "' class='amount_0' display-non-div' style='display:none;padding:0px;' width='5%'><input type='text' value=''  class='amounthide input-non-active' style='text-align:right;' name='amounthide' readonly /></td> \
    ...
    $get_lastIDEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, TotalAmount, Available) {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    <td id='products_0' class='products_0 ' width='15%'><input type='text' value='" + ItemCode + "'  class='producthide input-non-active' name='producthide' readonly /></td> \
                    ...
                    <td id='uom_0' class='uom_0'  width='5%'><input type='text' value='" + UnitSecondaryName + "'  class='uomhide input-non-active' name='uomhide' readonly /></td> \
                    ...
                    <td id='unitprice_0' class='unitprice_0' display-non-div' style='display:none;padding:0px;' width='10%'><input type='text' value='" + Price + "'  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
                    <td id='amount_0' class='amount_0' display-non-div' style='display:none;padding:0px;' width='10%'><input type='text' value='" + TotalAmount + "'  class='amounthide input-non-active' style='text-align:right;' name='amounthide' readonly /></td> \
            ...
            $lastChar = $lastChar + 1;
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    <td id='products_0" + $lastChar + "' class='products_0' width='15%'><input type='text' value='" + ItemCode + "'  class='producthide input-non-active' name='producthide' readonly /></td> \
                    ...
                    <td id='uom_0" + $lastChar + "' class='uom_0'  width='5%'><input type='text' value='" + UnitSecondaryName + "'  class='uomhide input-non-active' name='uomhide' readonly /></td> \
					<td id='of_0' class='of_0' width='5%'><input type='text' value='" + UnitFormula + "'  class='ofhide input-non-active' name='ofhide' style='text-align:right;' readonly /></td> \
                    <td id='baseuom_0' class='baseuom_0' width='8%'><input type='text' value='" + UnitName + "'  class='baseuomhide input-non-active' name='baseuomhide' readonly /></td> \
                    <td id='totalquantity_0' class='totalquantity_0 display-non-div' style='display:none;padding:0px;'   width='8%'><input type='text' value='" + TotalQuantity + "'  class='totalquantityhide input-non-active' style='text-align:right;' name='totalquantityhide' readonly /></td> \
                    ...
                    <td id='unitprice_0" + $lastChar + "' class='unitprice_0' display-non-div' style='display:none;padding:0px;' width='10%'><input type='text' value='" + Price + "'  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
                    <td id='amount_0" + $lastChar + "' class='amount_0' display-non-div' style='display:none;padding:0px;'  width='5%'><input type='text' value='" + TotalAmount + "'  class='amounthide input-non-active' style='text-align:right;' name='amounthide' readonly /></td> \
    ...
    $add_rowEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, TotalAmount, Available) {

        $get_lastIDEdit(ItemId, ItemCode, BarCode ,ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, TotalAmount, Available);
