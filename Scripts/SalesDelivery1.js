$(function () {
    ...
    $get_lastIDEdit = function (ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount,DiscountAmount, TotalAmount, Available) {
    ...
    $add_rowEdit = function (ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount,DiscountAmount, TotalAmount, Available) {

        $get_lastIDEdit(ItemId, ItemName, Description, Quantity, UnitId, UnitName, Price, Discount,DiscountAmount, TotalAmount, Available);
