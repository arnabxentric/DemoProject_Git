    ...
    $get_lastIDCost = function (add) {
        ...
        if ($id == null) {
            ...
            $newRowCost = "<tr id='tr'> \
                    ...
                    <td width='2%' align='center' style='background-color:#F9F9F9 !important; box-shadow:none !important'><img src='../../Images/icons-181e6a17.png' src='Delete' class='del_ExpenseRowCost' /></td> \
				</tr>"
            return $newRowCost;
        }
        else {
    ...
    $get_lastIDEditCost = function (CostingType, CostingId, CostName, Description, TaxId, TaxName, TotalAmount) {
        ...
        if ($id == null) {
            ...
            $newRowCost = "<tr id='tr'> \
                    ...
                    <td width='10%' align='center' style='background-color:#F9F9F9 !important; box-shadow:none !important'><img src='../../Images/icons-181e6a17.png' src='Delete' class='del_ExpenseRowCost' /></td> \
				</tr>"
            return $newRowCost;
        }
        else {
