    ...
    $get_lastIDEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available) {
        ...
        if ($id == null) {
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='unitprice_0" + $lastChar + "' class='unitprice_0' width='5%'><input type='text' value='" + Price + "'  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
