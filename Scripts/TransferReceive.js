    ...
    $get_lastID = function () {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='receivequantity_0' class='receivequantity_0' width='5%'><input type='text' value=''  class='receivequantityhide input-non-active' name='receivequantityhide' style='text-align:right;' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='receivequantity_0" + $lastChar + "' class='receivequantity_0' width='5%'><input type='text' value=''  class='receivequantityhide input-non-active' name='receivequantityhide' style='text-align:right;' style='text-align:right;' readonly /></td> \
    ...
    $get_lastIDEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, OrderQuantity, TransferQuantity, ReceiveQuantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName) {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='receivequantity_0' class='receivequantity_0' width='5%'><input type='text' value='" + ReceiveQuantity + "'  class='receivequantityhide input-non-active' name='receivequantityhide' style='text-align:right;' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='receivequantity_0" + $lastChar + "' class='receivequantity_0' width='5%'><input type='text' value='" + ReceiveQuantity + "'  class='receivequantityhide input-non-active' style='text-align:right;' name='receivequantityhide' readonly /></td> \
