$(function () {
    ...
    $get_lastID = function () {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='productcode_0 'class='productcode_0 ' width='10%'><input type='text' value=''  class='productcodehide input-non-active' name='productcodehide' readonly /></td> \
                    <td id='barcode_0' class='barcode_0 ' width='10%'><input type='text' value=''  class='barcodehide input-non-active' name='barcodehide' readonly /></td> \
                    ...
                    <td id='taxes_0' class='taxes_0' width='12%'><input type='text' value=''  class='taxhide input-non-active' name='taxhide' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='productcode_0" + $lastChar + "'class='productcode_0 ' width='10%'><input type='text' value=''  class='productcodehide input-non-active' name='productcodehide' readonly /></td> \
                    <td id='barcode_0" + $lastChar + "'class='barcode_0 ' width='10%'><input type='text' value=''  class='barcodehide input-non-active' name='barcodehide' readonly /></td> \
                    ...
                    <td id='taxes_0" + $lastChar + "' class='taxes_0' width='12%'><input type='text' value=''  class='taxhide input-non-active' name='taxhide' readonly /></td> \
    ...
    $get_lastIDEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available) {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    <td id='products_0' class='products_0 display-non-div' style='display:none;padding:0px;' width='12%'><input type='text' value='" + ItemCode + "'  class='producthide input-non-active' name='producthide' readonly /></td> \
                    <td id='productcode_0' class='productcode_0 ' width='8%'><input type='text' value='" + ItemName + "'  class='productcodehide input-non-active' name='productcodehide' readonly /></td> \
					...
					<td id='description_0' class='description_0' width='8%'><input type='text' value='" + Description + "'  class='descriptionhide input-non-active' name='descriptionhide' readonly /></td> \
					<td id='quantity_0' class='quantity_0 display-non-div' style='display:none;padding:0px;' width='5%'><input type='text' value='" + Quantity + "'  class='quantityhide input-non-active' name='quantityhide' style='text-align:right;' readonly /></td> \
					<td id='uom_0' class='uom_0 display-non-div' style='display:none;padding:0px;' width='8%'><input type='text' value='" + UnitName + "'  class='uomhide input-non-active' name='uomhide' readonly /></td> \
                    ...
                    <td id='baseuom_0' class='baseuom_0 ' width='3%'><input type='text' value='" + UnitName + "'  class='baseuomhide input-non-active' name='baseuomhide' readonly /></td> \
                    <td id='totalquantity_0' class='totalquantity_0'  width='3%'><input type='text' value='" + TotalQuantity + "'  class='totalquantityhide input-non-active' style='text-align:right;' name='totalquantityhide' readonly /></td> \
                    ...
                    <td id='unitprice_0' class='unitprice_0' width='3%'><input type='text' value='" + Price + "'  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
                    <td id='discount_0' class='discount_0 display-non-div' style='display:none;padding:0px;' width='5%'><input type='text' value='" + Discount + "'  class='discounthide input-non-active' style='text-align:right;' name='discounthide' readonly /></td> \
                    <td id='disamount_0' class='disamount_0' width='2%'><input type='text' value='" + DiscountAmount + "'  class='disamounthide input-non-active' style='text-align:right;' name='disamounthide' readonly /></td> \
                    <td id='taxes_0' class='taxes_0' width='6%'><input type='text' value='" + TaxName + "'  class='taxhide input-non-active' name='taxhide' readonly /></td> \
                    <td id='amount_0' class='amount_0' width='3%'><input type='text' value='" + TotalAmount + "'  class='amounthide input-non-active' style='text-align:right;' name='amounthide' readonly /></td> \
                    ...
                    <td id='baseuomhide_0' class='baseuomhide_0 display-non-div' style='display:none;padding:0px;'><input type='hidden' value='" + UnitId + "'  class='baseuom' name='baseuom' /></td> \
                  	<td width='2%' align='center' style='background-color:#F9F9F9 !important; box-shadow:none !important;display:none;padding:0px;'><img src='../../Images/icons-181e6a17.png' src='Delete' class='del_ExpenseRow' /></td> \
            ...
            $lastChar = $lastChar + 1;
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    <td id='products_0" + $lastChar + "' class='products_0 display-non-div' style='display:none;padding:0px;' width='12%'><input type='text' value='" + ItemCode + "'  class='producthide input-non-active' name='producthide' readonly /></td> \
                    <td id='productcode_0" + $lastChar + "' class='productcode_0 ' width='8%'><input type='text' value='" + ItemName + "'  class='productcodehide input-non-active' name='productcodehide' readonly /></td> \
				    ...
				    <td id='description_0" + $lastChar + "' class='description_0' width='8%'><input type='text' value='" + Description + "'  class='descriptionhide input-non-active' name='descriptionhide' readonly /></td> \
					<td id='quantity_0" + $lastChar + "' class='quantity_0 display-non-div' style='display:none;padding:0px;' width='5%'><input type='text' value='" + Quantity + "'  class='quantityhide input-non-active' style='text-align:right;' name='quantityhide' readonly /></td> \
					<td id='uom_0" + $lastChar + "' class='uom_0 display-non-div' style='display:none;padding:0px;' width='8%'><input type='text' value='" + UnitName + "'  class='uomhide input-non-active' name='uomhide' readonly /></td> \
                    ...
                    <td id='baseuom_0" + $lastChar + "' class='baseuom_0' width='3%'><input type='text' value='" + UnitName + "'  class='baseuomhide input-non-active' name='baseuomhide' readonly /></td> \
                    <td id='totalquantity_0" + $lastChar + "' class='totalquantity_0'  width='3%'><input type='text' value='" + TotalQuantity + "'  class='totalquantityhide input-non-active' style='text-align:right;' name='totalquantityhide' readonly /></td> \
                    ...
                    <td id='unitprice_0" + $lastChar + "' class='unitprice_0' width='3%'><input type='text' value='" + Price + "'  class='unitpricehide input-non-active' style='text-align:right;' name='unitpricehide' readonly /></td> \
                    <td id='discount_0" + $lastChar + "' class='discount_0 display-non-div' style='display:none;padding:0px; width='5%'><input type='text' value='" + Discount + "'  class='discounthide input-non-active' style='text-align:right;' name='discounthide' readonly /></td> \
                    <td id='disamount_0" + $lastChar + "' class='disamount_0 ' width='2%'><input type='text' value='" + DiscountAmount + "'  class='disamounthide input-non-active' style='text-align:right;' name='disamounthide' readonly /></td> \
                    <td id='taxes_0" + $lastChar + "' class='taxes_0' width='6%'><input type='text' value='" + TaxName + "'  class='taxhide input-non-active' name='taxhide' readonly /></td> \
                    <td id='amount_0" + $lastChar + "' class='amount_0' width='3%'><input type='text' value='" + TotalAmount + "'  class='amounthide input-non-active' style='text-align:right;' name='amounthide' readonly /></td> \
    ...
    $add_rowEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available) {

        $get_lastIDEdit(ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, Discount, DiscountAmount, TaxId, TaxName, TotalAmount, Available);
