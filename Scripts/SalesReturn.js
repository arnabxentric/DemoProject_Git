    ...
    $get_lastIDEdit = function (ItemId, ItemCode, BarCode, ItemName, Description, Quantity, UnitId, UnitName, SecUnitId, SecUnitName, SecUnitFormula, UnitFormula, UnitIdSecondary, UnitSecondaryName, TotalQuantity, Price, TaxId, TaxName, TotalAmount, Available) {
        ...
        if ($id == null) {
            $newRow = "<tr id='tr'> \
                    ...
                    <td id='barcode_0' class='barcode_0 ' width='10%'><input type='text' value='" + BarCode + "'  class='barcodehide input-non-active' name='barcodehide' readonly /></td> \
            ...
            $newRow = "<tr id='tr" + $lastChar + "'> \
                    ...
                    <td id='productcode_0" + $lastChar + "' class='productcode_0 ' width='10%'><input type='text' value='" + ItemName + "'  class='productcodehide input-non-active' name='productcodehide' readonly /></td> \
                    <td id='barcode_0" + $lastChar + "' class='barcode_0 ' width='10%'><input type='text' value='" + BarCode + "'  class='barcodehide input-non-active' name='barcodehide' readonly /></td> \
